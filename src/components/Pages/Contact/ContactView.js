    ...
    <div className={styles.container}>
      <div className={styles.wrapper}>
        ...
        <div className={styles.moreInfo}>
          ...
          <span>Or want to place an order? That's great! Give us a call or send us an email.</span>
          <span><i className="fas fa-phone"></i>+38(063)000-00-00</span>
          <span><i className="fas fa-envelope"></i>infoAnnetShop@gmail.com</span>
        </div>
      </div>
    </div>
  )
